...
<body>
    ...
    ?>
        <hr>
        <h1 class="text-center">Atenção você esqueceu o require do arquivo <br> <strong><code>logica-autenticacao.php</code></strong>! </h1>
    <?php
        die();
    }
            ...
            <div class="text-end">
                ...
                ?>
                    <span class="navbar-text">
                        <span data-feather="user" class="my-auto"></span>
                        <?php
                        if (isAdmin()) {
                            ?>
                            <span class="fs-5 mx-2 fw-bold text-danger"># <?= nome_usuario(); ?></span>
                        <?php
                        } else {
                        ?>
                            <span class="fs-5 mx-2 " ><?= nome_usuario(); ?></span>
                        <?php
                        }
                        ?>
