...
<html lang="pt-br" data-bs-theme="light">
  ...
  <body>
    ...
    <form action="destino1.php" class="form" method="POST">

    <div>

    <div class="row mb-3 justify-content-center">

      <label for="n1" class="col-sm-2 col-form-label text-end">Número 1:</label>
        <div class="col-sm-2">
          <input class="form-control" type="number" name="n1" id="n1">
        </div>

        <label for="n2" class="col-sm-2 col-form-label text-end">Número 2:</label>
        <div class="col-sm-2">
          <input class="form-control" type="number" name="n2" id="n2">
        </div>  

        <label for="n3" class="col-sm-2 col-form-label text-end">Número 3:</label>
        <div class="col-sm-2">
          <input class="form-control" type="number" name="n3" id="n3">
        </div>
    </div>    
